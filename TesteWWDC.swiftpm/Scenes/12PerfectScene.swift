...
class PerfectScene: SKScene {
    
    var textbox = SKSpriteNode(imageNamed: "textbox-big")
    var character = SKSpriteNode(imageNamed: "perfect")
    var textLabel = Label.textPerfectScene
    
    override func sceneDidLoad() {
        
        addBackground(bgname: "bg1")
        addTextBox(item: textbox, itemName: "textbox")
        addSpriteCharacter(character: character, characterName: "perfect")
